...
for ROLE in "roles/resourcemanager.projectCreator" "roles/resourcemanager.projectDeleter" "roles/resourcemanager.organizationAdmin" "roles/billing.admin roles/resourcemanager.folderAdmin roles/serviceusage.serviceUsageAdmin"; do
